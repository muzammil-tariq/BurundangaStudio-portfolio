<template>
    <div class="social">
        <ul>
            ...
            <li class="instagram">
                <a href="https://www.instagram.com/burundanga.studio/" target="_blank">
            ...
            <li class="twitter">
                <a href="https://twitter.com/burundanga_BCN" target="_blank">
            ...
            <li class="label">
                <span class="line"></span>Stay tunned!
            </li>
        </ul>
    </div>
</template>
